            ...
            <div class="featured-select">
                <div class="featured-item">
                    ...
                    <div class="item-overlay">
                        ...
                        <div class="item-link">
                            <a href="prod-desc.php?prod_id=13" class="btn-gallery">></a>
                        </div>
                    </div>
                </div>
                <div class="featured-item">
                    ...
                    <div class="item-overlay">
                        ...
                        <div class="item-link">
                            <a href="prod-desc.php?prod_id=14" class="btn-gallery">></a>
                        </div>
                    </div>
                </div>
                <div class="featured-item">
                    ...
                    <div class="item-overlay">
                        ...
                        <div class="item-link">
                            <a href="prod-desc.php?prod_id=15" class="btn-gallery">></a>
                        </div>
                    </div>
                </div>
                <div class="featured-item">
                    ...
                    <div class="item-overlay">
                        ...
                        <div class="item-link">
                            <a href="prod-desc.php?prod_id=16" class="btn-gallery">></a>
                        </div>
                    </div>
                </div>
            </div>
