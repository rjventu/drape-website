            ...
            <div class="featured-select">
                <div class="featured-item">
                    ...
                    <div class="item-overlay">
                        ...
                        <div class="item-link">
                            <a href="prod-desc.php?prod_id=9" class="btn-gallery">></a>
                        </div>
                    </div>
                </div>
                <div class="featured-item">
                    ...
                    <div class="item-overlay">
                        ...
                        <div class="item-link">
                            <a href="prod-desc.php?prod_id=10" class="btn-gallery">></a>
                        </div>
                    </div>
                </div>
                <div class="featured-item">
                    ...
                    <div class="item-overlay">
                        ...
                        <div class="item-link">
                            <a href="prod-desc.php?prod_id=11" class="btn-gallery">></a>
                        </div>
                    </div>
                </div>
                <div class="featured-item">
                    ...
                    <div class="item-overlay">
                        ...
                        <div class="item-link">
                            <a href="prod-desc.php?prod_id=12" class="btn-gallery">></a>
                        </div>
                    </div>
                </div>
            </div>
